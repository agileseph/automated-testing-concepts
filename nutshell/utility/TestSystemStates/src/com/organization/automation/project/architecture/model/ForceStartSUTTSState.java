...
public class ForceStartSUTTSState implements TSState {

	private static final Logger LOGGER = LoggerFactory.getLogger(ForceStartSUTTSState.class);
	
	private final TestSystem testSystem;
	
	public ForceStartSUTTSState(TestSystem testSystem) {
	...
	public void force() throws Exception {
		LOGGER.info("[TestSystem]      State Force");
		
		// force start the SUT
		
		// check after force start
