 ...
 */
package com.organization.automation.project.spice.mix.testng.extension.aop.guice;

import org.testng.annotations.Parameters;
import org.testng.annotations.Test;

import com.organization.automation.project.spice.mix.aop.guice.TCProxy;
...
@Test(groups = { "GuiceProxyTests" })
public class GuiceProxyUnitTests extends ProjectTestSetTexture {

	@Parameters({ "test-set_unit-tests-guice-proxy" })
	public GuiceProxyUnitTests(final String name) {
		super();
		setName(name);
	}
	...
	public void testAspectJSpringProxy_PositiveCaseWithConstructorParameter(final ITestCase tcProxy, final String expected) throws TCException {
		String actual = ((AssistedAbstractTestCase) tcProxy).getId();
