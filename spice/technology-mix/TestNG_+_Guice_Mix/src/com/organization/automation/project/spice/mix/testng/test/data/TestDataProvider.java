...
import com.organization.automation.project.spice.mix.aop.guice.LogTestStepModule;
import com.organization.automation.project.spice.mix.aop.guice.LogTestStepModuleSpecial;
...
public class TestDataProvider extends TestSetTexture {
	...
	protected Object[][] createTestData_AbstractTCLogAspect() {
		return new Object[][]{
							 	{ new AbstractTestCase(),
							 	  new TCProxy(new LogTestStepModule()) }
							 };
	}	
	...
	protected Object[][] createTestData_AbstractTCConstructorParameter() {
		String expected = "100";
		TCProxy proxy = new TCProxy(new LogTestStepModuleSpecial());
		
		return new Object[][]{
							 	{ proxy.getTCFactory().create(expected),
							 	  expected }
							 };
	}	
}
