...
public class AutomationProjectTestListener extends TestListenerAdapter implements IHookable {
	...
	@Override
	public void run(IHookCallBack invocation, ITestResult tr) {
		LOGGER.info("[TEST]         [HOOK] before run test method");
		
		invocation.runTestMethod(tr);
		
		LOGGER.info("[TEST]         [HOOK] after run test method");
	}
