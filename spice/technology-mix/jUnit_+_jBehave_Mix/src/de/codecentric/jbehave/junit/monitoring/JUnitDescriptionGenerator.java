...
public class JUnitDescriptionGenerator {
	...
	private void addNonExistingStep(Description description, String stringStepOneLine,
		...
		try {
			...
			System.out.println("While adding non existing step, it was the error: " + e.toString());
		}
	}
	...
	private String stripLinebreaks(String stringStep) {
		String newStep = stringStep;
		int indexEndOfLine = stringStep.indexOf('\n');
		
		if (indexEndOfLine != -1) {
			newStep = stringStep.substring(0, indexEndOfLine);
		}
